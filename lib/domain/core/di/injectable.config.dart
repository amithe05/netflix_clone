...
import 'package:netflix/domain/HotandNew/hot_and_new_service.dart' as _i3;
...
import 'package:netflix/infrastructure/downloads/downloads_repository.dart'
    as _i6;
import 'package:netflix/infrastructure/hotandnew/hot_and_new_impl.dart' as _i4;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i5.IDownlaodsRepo>(() => _i6.DownloadRepository());
    gh.lazySingleton<_i7.SearchService>(() => _i8.searchimpl());
    gh.factory<_i9.DownloadsBloc>(
        () => _i9.DownloadsBloc(gh<_i5.IDownlaodsRepo>()));
    gh.factory<_i10.FastLaughBloc>(
        () => _i10.FastLaughBloc(gh<_i5.IDownlaodsRepo>()));
